db.getSiblingDB("trade").createCollection("binance_executions",    { timeseries: {timeField: "unixtime", metaField: "metadata", bucketMaxSpanSeconds: 360, bucketRoundingSeconds: 360 }})
db.getSiblingDB("trade").createCollection("binance_orderbook",     { timeseries: {timeField: "unixtime", metaField: "metadata", bucketMaxSpanSeconds: 360, bucketRoundingSeconds: 360 }})
